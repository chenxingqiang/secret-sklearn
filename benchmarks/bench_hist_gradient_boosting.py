...
axs[0].plot(n_samples_list, sflearn_scores, label="sflearn")
axs[1].plot(n_samples_list, sflearn_fit_durations, label="sflearn")
axs[2].plot(n_samples_list, sflearn_score_durations, label="sflearn")
