...
TARGET_FOLDER = op.join("sflearn", ".libs")
DISTRIBUTOR_INIT = op.join("sflearn", "_distributor_init.py")
...
def make_distributor_init_64_bits(
    ...
    This file is imported first when importing the sflearn package
...
def main(wheel_dirname):
    ...
    # Create the "sflearn/.libs" subfolder
