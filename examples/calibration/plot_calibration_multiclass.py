...
# -----------------------
#
# First, we will train a :class:`~sflearn.ensemble.RandomForestClassifier`
...
# :class:`~sflearn.ensemble.RandomForestClassifier` but train it using only
...
# :class:`~sflearn.ensemble.RandomForestClassifier` which would have resulted
