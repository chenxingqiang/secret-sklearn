...
# %%
# :class:`~sflearn.linear_model.LogisticRegression` returns well calibrated
...
#
# * :class:`~sflearn.naive_bayes.GaussianNB` tends to push
...
#
# * :class:`~sflearn.ensemble.RandomForestClassifier` shows the opposite
...
#
# * To show the performance of :class:`~sflearn.svm.LinearSVC`, we naively
...
#   :class:`~sflearn.svm.LinearSVC` shows an
#   even more sigmoid curve than the
#   :class:`~sflearn.ensemble.RandomForestClassifier`, which is typical for
