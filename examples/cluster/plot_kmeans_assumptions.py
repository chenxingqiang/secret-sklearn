...
# ---------------
#
# The function :func:`~sflearn.datasets.make_blobs` generates isotropic
...
# :class:`~sflearn.cluster.KMeans` behaves in the following scenarios:
#
...
# :class:`~sflearn.mixture.GaussianMixture`, which also assumes gaussian
