...
This example shows how one can use :class:`~sflearn.preprocessing.KBinsDiscretizer`
...
# :class:`~sflearn.preprocessing.KBinsDiscretizer`. We need to choose a strategy
...
# %%
# Indeed, the output of the :class:`~sflearn.preprocessing.KBinsDiscretizer` is
