...
# ---------------
#
# We use :class:`~sflearn.datasets.make_blobs` to create 3 synthetic clusters.
...
# --------------
#
# One can access the labels assigned by :class:`~sflearn.cluster.DBSCAN` using
...
# However, since :class:`~sflearn.datasets.make_blobs` gives access to the true
