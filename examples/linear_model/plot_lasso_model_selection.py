...
# --------------------------------------------
# :class:`~sflearn.linear_model.LassoLarsIC` provides a Lasso estimator that
...
# :class:`~sflearn.preprocessing.StandardScaler`. In addition, we will
...
# cross-validation: :class:`~sflearn.linear_model.LassoCV` and
# :class:`~sflearn.linear_model.LassoLarsCV` that respectively solve the
...
# :class:`~sflearn.linear_model.LassoCV`.
...
# ................................
# Let's start by making the hyperparameter tuning using
# :class:`~sflearn.linear_model.LassoLarsCV`.
