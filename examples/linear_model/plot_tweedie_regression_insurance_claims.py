...
#   more than one claim.
from sflearn.linear_model import GammaRegressor
...
# :class:`~sflearn.linear.GammaRegressor` is able to leverage some information
...
#
# The :func:`sflearn.metrics.mean_tweedie_deviance` depends on a `power`
