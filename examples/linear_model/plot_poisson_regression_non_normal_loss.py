...
from sflearn.preprocessing import FunctionTransformer, OneHotEncoder
...
# :class:`~sflearn.linear_model.Ridge`) we ignore the corresponding samples,
# meaning that the obtained Poisson deviance is approximate. An alternative
# approach could be to use :class:`~sflearn.compose.TransformedTargetRegressor`
...
# integer using :class:`~sflearn.preprocessing.OrdinalEncoder`. With this
...
# :class:`~sflearn.preprocessing.OrdinalEncoder` over the
# :class:`~sflearn.preprocessing.OneHotEncoder` is that it will make training
# faster.
#
...
# (:func:`~sflearn.preprocessing.PolynomialFeatures`) indeed increases their
