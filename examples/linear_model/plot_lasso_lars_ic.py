...
:class:`~sflearn.linear_model.LassoLarsIC` estimator is fit on a
...
.. note::
    ...
    :class:`~sflearn.linear_model.LassoLarsIC` relies on the AIC or BIC
...
# :class:`~sflearn.linear_model.LinearLarsIC` that uses either Akaike's
...
from sflearn.linear_model import LassoLarsIC
