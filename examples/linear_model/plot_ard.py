...
import pandas as pd
from sflearn.linear_model import ARDRegression, LinearRegression, BayesianRidge
...
from sflearn.preprocessing import PolynomialFeatures, StandardScaler
...
# :class:`~sflearn.linear_model.ARDRegression` and
# :class:`~sflearn.linear_model.BayesianRidge`, then
# :class:`~sflearn.preprocessing.PolynomialFeatures` should not introduce an
