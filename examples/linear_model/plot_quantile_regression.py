...
# :class:`~sflearn.linear_model.LinearRegression` less efficient, i.e. we need
...
# :class:`~sflearn.linear_model.QuantileRegressor` can be used in practice and
# give the intuition into the properties of the fitted models. Finally,
# we will compare the both :class:`~sflearn.linear_model.QuantileRegressor`
# and :class:`~sflearn.linear_model.LinearRegression`.
#
...
# :class:`~sflearn.linear_model.QuantileRegressor` and
# :class:`~sflearn.linear_model.LinearRegression` are minimizing.
#
# Indeed, :class:`~sflearn.linear_model.LinearRegression` is a least squares
# approach minimizing the mean squared error (MSE) between the training and
# predicted targets. In contrast,
# :class:`~sflearn.linear_model.QuantileRegressor` with `quantile=0.5`
...
# :class:`~sflearn.linear_model.QuantileRegressor` than
# :class:`~sflearn.linear_model.LinearRegression`. In contrast to that, MSE is
# lower for :class:`~sflearn.linear_model.LinearRegression` than
# :class:`~sflearn.linear_model.QuantileRegressor`. These results confirms that
# MAE is the loss minimized by :class:`~sflearn.linear_model.QuantileRegressor`
# while MSE is the loss minimized
# :class:`~sflearn.linear_model.LinearRegression`.
#
