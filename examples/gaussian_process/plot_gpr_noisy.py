...
:class:`~sflearn.gaussian_process.kernels.WhiteKernel` to estimate the noise
...
# :class:`~sflearn.gaussian_process.GaussianProcessRegressor`
# using an additive kernel adding a
# :class:`~sflearn.gaussian_process.kernels.RBF` and
# :class:`~sflearn.gaussian_process.kernels.WhiteKernel` kernels.
# The :class:`~sflearn.gaussian_process.kernels.WhiteKernel` is a kernel that
# will able to estimate the amount of noise present in the data while the
# :class:`~sflearn.gaussian_process.kernels.RBF` will serve at fitting the
...
from sflearn.gaussian_process.kernels import RBF, WhiteKernel
...
# :class:`~sflearn.gaussian_process.kernels.RBF` with a
# larger `length_scale` and the
# :class:`~sflearn.gaussian_process.kernels.WhiteKernel`
