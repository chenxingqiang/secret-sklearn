...
:class:`~sflearn.feature_selection.SelectFromModel` which is based on feature
importance, and
:class:`~sflearn.feature_selection.SequentialFeatureSelection` which relies
...
# :class:`~sflearn.linear_model.RidgeCV` estimator. The features with the
...
# to the coefficients. The :class:`~sflearn.feature_selection.SelectFromModel`
# is meant just for that. :class:`~sflearn.feature_selection.SelectFromModel`
...
# :class:`~sflearn.feature_selection.SelectFromModel` is significantly faster
# than SFS. Indeed, :class:`~sflearn.feature_selection.SelectFromModel` only
...
# :class:`~sflearn.feature_selection.SelectFromModel` requires the underlying
