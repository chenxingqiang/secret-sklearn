...
# :class:`~sflearn.linear_model.PoissonRegressor`,
# :class:`~sflearn.linear_model.GammaRegressor`, and
# :class:`~sflearn.linear_model.TweedieRegressor`. The Poisson regressor can be
...
# :class:`~sflearn.ensemble.HistGradientBoostingRegressor` supports a new
# 'poisson' loss as well.

import numpy as np
from sflearn.model_selection import train_test_split
from sflearn.linear_model import PoissonRegressor
...
# ------------------------------------------------
# The :class:`~sflearn.cluster.KMeans` estimator was entirely re-worked, and it
...
from sflearn.metrics import completeness_score
...
# :class:`~sflearn.ensemble.HistGradientBoostingRegressor`. On top of the
...
# ----------------------------------------------
# The two linear regressors :class:`~sflearn.linear_model.Lasso` and
# :class:`~sflearn.linear_model.ElasticNet` now support sample weights.
