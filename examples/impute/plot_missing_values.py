...
value using the basic :class:`~sflearn.impute.SimpleImputer`.
...
of
:class:`~sflearn.ensemble.RandomForestRegressor` on the full original dataset
...
from sflearn.impute import SimpleImputer, KNNImputer, IterativeImputer
...
# ------------------------------------
#
# :class:`~sflearn.impute.KNNImputer` imputes missing values using the weighted
...
# ------------------------------------------
#
# Another option is the :class:`~sflearn.impute.IterativeImputer`. This uses
