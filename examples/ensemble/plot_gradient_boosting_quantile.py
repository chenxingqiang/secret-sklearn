...
from sflearn.metrics import mean_pinball_loss, mean_squared_error
...
# %%
# Notice that :class:`~sflearn.ensemble.HistGradientBoostingRegressor` is much
# faster than :class:`~sflearn.ensemble.GradientBoostingRegressor` starting with
