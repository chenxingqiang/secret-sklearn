...
from sflearn.ensemble import RandomForestClassifier, GradientBoostingClassifier
...
# %%
# Notice that :class:`~sflearn.ensemble.HistGradientBoostingClassifier` is much
# faster than :class:`~sflearn.ensemble.GradientBoostingClassifier` starting
# with intermediate datasets (`n_samples >= 10_000`), which is not the case of
# the present example.
#
# The :class:`~sflearn.ensemble.RandomTreesEmbedding` is an unsupervised method
