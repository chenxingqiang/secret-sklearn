...
An example using :class:`~sflearn.ensemble.IsolationForest` for anomaly
detection.
...
# slightly deformed.
#
# For consistency with the :class:`~sflearn.ensemble.IsolationForest` notation,
...
# -------------------------------
#
# We use the class :class:`~sflearn.inspection.DecisionBoundaryDisplay` to
...
# :class:`~sflearn.inspection.DecisionBoundaryDisplay` represents the measure of
