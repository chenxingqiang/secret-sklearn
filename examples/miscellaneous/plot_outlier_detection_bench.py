...
2. The ROC curve from :class:`~sflearn.metrics.RocCurveDisplay` is computed
...
# :class:`sflearn.datasets` and the sample size of some datasets is reduced
...
import numpy as np
from sflearn.datasets import fetch_kddcup99, fetch_covtype, fetch_openml
...
# :class:`~sflearn.neighbors.LocalOutlierFactor` and
# :class:`~sflearn.ensemble.IsolationForest`. The goal is to show that
