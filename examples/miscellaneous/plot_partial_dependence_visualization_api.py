...
=========================================
The :class:`~sflearn.inspection.PartialDependenceDisplay` object can be used
...
# :func:`~sflearn.inspection.PartialDependenceDisplay.from_estimator` expects to plot
...
# :func:`~sflearn.inspection.PartialDependenceDisplay.from_estimator` to change the
# color of the curve.
fig, ax = plt.subplots(figsize=(12, 6))
...
# :class:`~sflearn.inspection.PartialDependenceDisplay` objects contain all the
...
# :func:`~sflearn.inspection.PartialDependenceDisplay.plot` functions of
...
# :func:`~sflearn.inspection.PartialDependenceDisplay.plot` function as a list,
