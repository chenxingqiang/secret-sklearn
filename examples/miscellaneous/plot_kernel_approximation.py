...
stochastic gradient descent via :class:`~sflearn.linear_model.SGDClassifier`.
...
from sflearn import datasets, svm, pipeline
from sflearn.kernel_approximation import RBFSampler, Nystroem
