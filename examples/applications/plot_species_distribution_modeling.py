...
density estimation problem and use the :class:`~sflearn.svm.OneClassSVM`
...
from sflearn.datasets import fetch_species_distributions
from sflearn import svm, metrics
