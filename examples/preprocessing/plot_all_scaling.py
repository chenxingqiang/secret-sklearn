...
:class:`~sflearn.preprocessing.QuantileTransformer` provides non-linear
transformations in which distances
between marginal outliers and inliers are shrunk.
:class:`~sflearn.preprocessing.PowerTransformer` provides
...
# --------------
#
# :class:`~sflearn.preprocessing.StandardScaler` removes the mean and scales
...
#
# :class:`~sflearn.preprocessing.StandardScaler` therefore cannot guarantee
...
# ------------
#
# :class:`~sflearn.preprocessing.MinMaxScaler` rescales the data set such that
# all feature values are in
# the range [0, 1] as shown in the right panel below. However, this scaling
# compresses all inliers into the narrow range [0, 0.005] for the transformed
# average house occupancy.
#
# Both :class:`~sflearn.preprocessing.StandardScaler` and
# :class:`~sflearn.preprocessing.MinMaxScaler` are very sensitive to the
# presence of outliers.
...
# ------------
#
# :class:`~sflearn.preprocessing.MaxAbsScaler` is similar to
# :class:`~sflearn.preprocessing.MinMaxScaler` except that the
...
# On positive only data, both :class:`~sflearn.preprocessing.MinMaxScaler`
# and :class:`~sflearn.preprocessing.MaxAbsScaler` behave similarly.
# :class:`~sflearn.preprocessing.MaxAbsScaler` therefore also suffers from
...
# :class:`~sflearn.preprocessing.RobustScaler`
...
# ----------------
#
# :class:`~sflearn.preprocessing.PowerTransformer` applies a power
...
# methods. By default, :class:`~sflearn.preprocessing.PowerTransformer` applies
...
# ------------------------------------
#
# :class:`~sflearn.preprocessing.QuantileTransformer` applies a non-linear
...
#
# :class:`~sflearn.preprocessing.RobustScaler` and
# :class:`~sflearn.preprocessing.QuantileTransformer` are robust to outliers in
...
# :class:`~sflearn.preprocessing.RobustScaler`,
# :class:`~sflearn.preprocessing.QuantileTransformer` will also automatically
...
# ----------
#
# The :class:`~sflearn.preprocessing.Normalizer` rescales the vector for each
