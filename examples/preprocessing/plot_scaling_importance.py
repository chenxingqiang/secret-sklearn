...
principal components found using :class:`~sflearn.decomposition.PCA` on unscaled
data with those obatined when using a
:class:`~sflearn.preprocessing.StandardScaler` to scale data first.
...
from sflearn.datasets import load_wine
...
# :class:`~sflearn.neighbors.KNeighborsClassifier`, in this section we select a
...
# :class:`~sflearn.preprocessing.StandardScaler` to normalize this database,
...
# ==================================================
#
# Dimensional reduction using :class:`~sflearn.decomposition.PCA` consists of
...
# :class:`~sflearn.decomposition.PCA` would determine that such feature
...
# :class:`~sflearn.linear_model.LogisticRegressionCV` depends on the scaling or
# non-scaling of the data:

import numpy as np
from sflearn.pipeline import make_pipeline
from sflearn.linear_model import LogisticRegressionCV
...
# scaled before :class:`~sflearn.decomposition.PCA`, as it vastly outperforms
...
# scaling before using :class:`~sflearn.decomposition.PCA`.
#
