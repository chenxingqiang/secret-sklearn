...
:class:`~sflearn.covariance.EmpiricalCovariance`. It is unbiased, i.e. it
...
from sflearn.covariance import ShrunkCovariance, empirical_covariance, log_likelihood
...
#   criterion), yielding the :class:`~sflearn.covariance.LedoitWolf`
#   covariance estimate.
#
# * An improvement of the Ledoit-Wolf shrinkage, the
#   :class:`~sflearn.covariance.OAS`, proposed by Chen et al. Its
#   convergence is significantly better under the assumption that the data
#   are Gaussian, in particular for small samples.


from sflearn.model_selection import GridSearchCV
from sflearn.covariance import LedoitWolf, OAS
