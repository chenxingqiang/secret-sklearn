...
Two algorithms are demoed: :class:`~sflearn.cluster.KMeans` and its more
scalable variant, :class:`~sflearn.cluster.MiniBatchKMeans`. Additionally,
...
:class:`~sflearn.feature_extraction.text.TfidfVectorizer` and a
:class:`~sflearn.feature_extraction.text.HashingVectorizer`. See the example
...
# the `remove` parameter from :func:`~sflearn.datasets.fetch_20newsgroups` to
...
#
# - :class:`~sflearn.feature_extraction.text.TfidfVectorizer` uses an in-memory
...
#
# - :class:`~sflearn.feature_extraction.text.HashingVectorizer` hashes word
...
# :class:`~sflearn.feature_extraction.text.TfidfVectorizer`.
...
# -----------------------------------
#
# As both :class:`~sflearn.cluster.KMeans` and
# :class:`~sflearn.cluster.MiniBatchKMeans` optimize a non-convex objective
...
# :class:`~sflearn.decomposition.TruncatedSVD`, which works on term count/tf-idf
# matrices. Since SVD results are not normalized, we redo the normalization to
# improve the :class:`~sflearn.cluster.KMeans` result. Using SVD to reduce the
...
# both :class:`~sflearn.cluster.KMeans` and
# :class:`~sflearn.cluster.MiniBatchKMeans`.
...
# ---------------------
#
# Since :class:`~sflearn.feature_extraction.text.TfidfVectorizer` can be
...
# :class:`~sflearn.feature_extraction.text.HashingVectorizer` instance, which
...
# :class:`~sflearn.feature_extraction.text.HashingVectorizer` output to a
# :class:`~sflearn.feature_extraction.text.TfidfTransformer` instance. In this
...
# %%
# :class:`~sflearn.cluster.KMeans` and :class:`~sflearn.cluster.MiniBatchKMeans`
...
#
# The size of the error bars show that :class:`~sflearn.cluster.MiniBatchKMeans`
# is less stable than :class:`~sflearn.cluster.KMeans` for this relatively small
