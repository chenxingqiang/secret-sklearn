...
# :class:`~sflearn.linear_model.RidgeClassifier` class. This is a linear
...
# :class:`~sflearn.linear_model.RidgeClassifier` does not
...
from sflearn.utils.extmath import density
