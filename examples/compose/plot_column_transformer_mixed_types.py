...
from sflearn.preprocessing import StandardScaler, OneHotEncoder
from sflearn.linear_model import LogisticRegression
from sflearn.model_selection import train_test_split, RandomizedSearchCV
...
# :func:`sflearn.compose.make_column_selector` gives this possibility.
...
from sflearn.compose import make_column_selector as selector
...
# :class:`~sflearn.model_selection.RandomizedSearchCV`. This
...
# :class:`~sflearn.model_selection.GridSearchCV` but the cartesian product of
