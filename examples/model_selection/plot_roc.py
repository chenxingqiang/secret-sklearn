...
# %%
# We train a :class:`~sflearn.linear_model.LogisticRegression` model which can
...
#     via the :class:`~sflearn.multiclass.OneVsRestClassifier` meta-estimator).
...
#
# In this section we use a :class:`~sflearn.preprocessing.LabelBinarizer` to
...
# :class:`~sflearn.metrics.roc_curve` and then the area under the curve with
# :class:`~sflearn.metrics.auc` for the raveled true and predicted classes.
...
# :class:`~sflearn.metrics.roc_auc_score` function.
