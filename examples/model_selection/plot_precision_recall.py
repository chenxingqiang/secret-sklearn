...
(:func:`sflearn.metrics.auc`) are common ways to summarize a precision-recall
...
.. note::
    ...
    See also :func:`sflearn.metrics.average_precision_score`,
             :func:`sflearn.metrics.recall_score`,
             :func:`sflearn.metrics.precision_score`,
             :func:`sflearn.metrics.f1_score`
"""
...
# :class:`~sflearn.metrics.PrecisionRecallDisplay`. Indeed, there is two
...
# predictions. We use
# :func:`~sflearn.metrics.PrecisionRecallDisplay.from_estimator` that
...
# :func:`~sflearn.metrics.PrecisionRecallDisplay.from_predictions`.
...
# %%
# We use :class:`~sflearn.multiclass.OneVsRestClassifier` for multi-label
# prediction.
