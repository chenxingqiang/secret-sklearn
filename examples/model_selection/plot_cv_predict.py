...
:func:`~sflearn.model_selection.cross_val_predict` together with
:class:`~sflearn.metrics.PredictionErrorDisplay` to visualize prediction
errors.
"""
...
# %%
# :func:`~sflearn.model_selection.cross_val_predict` returns an array of the
...
# :class:`~sflearn.metrics.PredictionErrorDisplay` to visualize the
# prediction errors.
#
...
# :func:`~sflearn.model_selection.cross_val_predict` for visualization
...
# :func:`~sflearn.model_selection.cross_val_predict`
...
# :func:`~sflearn.model_selection.cross_val_score` or
# :func:`~sflearn.model_selection.cross_validate` instead.
