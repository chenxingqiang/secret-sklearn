...
# %%
# We first define the parameter space for an :class:`~sflearn.svm.SVC`
# estimator, and compute the time required to train a
# :class:`~sflearn.model_selection.HalvingGridSearchCV` instance, as well as a
# :class:`~sflearn.model_selection.GridSearchCV` instance.
...
# :class:`~sflearn.svm.SVC` instance. The
# :class:`~sflearn.model_selection.HalvingGridSearchCV` also shows the
...
#
# We can see that the :class:`~sflearn.model_selection.HalvingGridSearchCV`
# class is able to find parameter combinations that are just as accurate as
# :class:`~sflearn.model_selection.GridSearchCV`, in much less time.
