...
trained and evaluated using :class:`~sflearn.model_selection.GridSearchCV`.
...
from sflearn.datasets import make_moons
...
# %%
# We will compare the performance of :class:`~sflearn.svm.SVC` estimators that
...
# :class:`~sflearn.model_selection.RepeatedStratifiedKFold`, repeating 10 times
...
# :class:`~sflearn.metrics.roc_auc_score`.

from sflearn.model_selection import GridSearchCV, RepeatedStratifiedKFold
...
# output of :class:`~sflearn.model_selection.GridSearchCV` does not provide
...
# evaluated with :class:`~sflearn.model_selection.GridSearchCV`. In this case
...
# :class:`~sflearn.model_selection.GridSearchCV`, does not significantly
...
# :class:`~sflearn.model_selection.GridSearchCV` `'rbf'`, has approximately a
