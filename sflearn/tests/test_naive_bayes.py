...
from sflearn.naive_bayes import GaussianNB, BernoulliNB
from sflearn.naive_bayes import MultinomialNB, ComplementNB
from sflearn.naive_bayes import CategoricalNB
