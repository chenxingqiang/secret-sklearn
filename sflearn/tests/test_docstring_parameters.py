...
from sflearn.utils._testing import check_docstring_parameters
from sflearn.utils._testing import _get_func_name
...
with warnings.catch_warnings():
    ...
    sflearn_path = sflearn.__path__  # type: ignore  # mypy issue #1422
    PUBLIC_MODULES = set(
        [
            pckg[1]
            for pckg in walk_packages(prefix="sflearn.", path=sflearn_path)
...
_DOCSTRING_IGNORES = [
    "sflearn.utils.deprecation.load_mlcomp",
    "sflearn.pipeline.make_pipeline",
    "sflearn.pipeline.make_union",
    "sflearn.utils.extmath.safe_sparse_dot",
    "sflearn.utils._joblib",
]
...
def test_docstring_parameters():
    ...
    for name in PUBLIC_MODULES:
        ...
        classes = [cls for cls in classes if cls[1].__module__.startswith("sflearn")]
...
def test_tabs():
    ...
    for importer, modname, ispkg in walk_packages(sflearn.__path__, prefix="sflearn."):
