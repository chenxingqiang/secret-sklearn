...
class PartialDependenceDisplay:
    ...
    :func:`~sflearn.inspection.PartialDependenceDisplay.from_estimator` to create a
    :class:`~sflearn.inspection.PartialDependenceDisplay`. All parameters are
    ...
    pd_results : list of Bunch
        Results of :func:`~sflearn.inspection.partial_dependence` for
        ``features``.
    ...
    pdp_lim : dict or None
        ...
        .. deprecated:: 1.1
           ...
           :meth:`~sflearn.inspection.PartialDependenceDisplay.plot` instead.
    ...
    def from_estimator(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~sflearn.inspection.PartialDependenceDisplay`
    ...
    def plot(
        ...
        *,
        ...
        -------
        display : :class:`~sflearn.inspection.PartialDependenceDisplay`
            Returns a :class:`~sflearn.inspection.PartialDependenceDisplay`
