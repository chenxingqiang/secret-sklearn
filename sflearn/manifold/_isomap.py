...
class Isomap(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    p : int, default=2
        ...
        sflearn.metrics.pairwise.pairwise_distances. When p = 1, this is
    ...
    kernel_pca_ : object
        :class:`~sflearn.decomposition.KernelPCA` object used to implement the
        embedding.

    nbrs_ : sflearn.neighbors.NearestNeighbors instance
