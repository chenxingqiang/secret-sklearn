...
def barycenter_kneighbors_graph(X, n_neighbors, reg=1e-3, n_jobs=None):
    ...
    See Also
    --------
    sflearn.neighbors.kneighbors_graph
    sflearn.neighbors.radius_neighbors_graph
    """
...
class LocallyLinearEmbedding(
    ...
    neighbors_algorithm : {'auto', 'brute', 'kd_tree', 'ball_tree'}, \
        ...
        :class:`~sflearn.neighbors.NearestNeighbors` instance.
    ...
    >>> from sflearn.manifold import LocallyLinearEmbedding
