...
# mypy error: Module 'sflearn.manifold' has no attribute '_utils'
...
def trustworthiness(X, X_embedded, *, n_neighbors=5, metric="euclidean"):
    ...
    metric : str or callable, default='euclidean'
        ...
        `sflearn.pairwise.pairwise_distances` and metrics listed in
        `sflearn.metrics.pairwise.PAIRWISE_DISTANCE_FUNCTIONS`. Note that the
        "cosine" metric uses :func:`~sflearn.metrics.pairwise.cosine_distances`.
...
class TSNE(BaseEstimator):
    ...
    See Also
    --------
    sflearn.decomposition.PCA : Principal component analysis that is a linear
        dimensionality reduction method.
    sflearn.decomposition.KernelPCA : Non-linear dimensionality reduction using
        kernels and PCA.
