...
:class:`~sflearn.ensemble.HistGradientBoostingRegressor` when they were still
:term:`experimental`, but these estimators are now stable and can be imported
normally from `sflearn.ensemble`.
"""
...
warnings.warn(
    ...
    "stable and can be normally imported from sflearn.ensemble."
)
