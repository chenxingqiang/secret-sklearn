...
class SGDClassifier(BaseSGDClassifier):
    ...
    loss : {'hinge', 'log_loss', 'log', 'modified_huber', 'squared_hinge',\
        ...
        - The other losses, 'squared_error', 'huber', 'epsilon_insensitive' and
          ...
          :class:`~sflearn.linear_model.SGDRegressor` for a description.
    ...
    See Also
    --------
    sflearn.svm.LinearSVC : Linear support vector classification.
    ...
    def predict_proba(self, X):
        ...
        the classifier with
        :class:`~sflearn.calibration.CalibratedClassifierCV` instead.
...
class SGDRegressor(BaseSGDRegressor):
    ...
    sflearn.svm.SVR : Epsilon-Support Vector Regression.
...
class SGDOneClassSVM(BaseSGD, OutlierMixin):
    ...
    technique (e.g. `sflearn.kernel_approximation.Nystroem`) to obtain results
    similar to `sflearn.svm.OneClassSVM` which uses a Gaussian kernel by
    default.
    ...
    See Also
    --------
    sflearn.svm.OneClassSVM : Unsupervised Outlier Detection.

    Notes
    -----
    This estimator has a linear complexity in the number of training samples
    and is thus better suited than the `sflearn.svm.OneClassSVM`
