...
class RANSACRegressor(
    ...
    estimator : object, default=None
        ...
        :class:`~sflearn.linear_model.LinearRegression` is used for
    ...
    min_samples : int (>= 1) or float ([0, 1]), default=None
        ...
        ``sflearn.linear_model.LinearRegression()`` estimator is assumed and
    ...
    Examples
    --------
    >>> from sflearn.linear_model import RANSACRegressor
