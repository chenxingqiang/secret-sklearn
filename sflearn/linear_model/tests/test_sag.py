...
from sflearn._loss.loss import HalfMultinomialLoss
from sflearn.linear_model._linear_loss import LinearModelLoss
from sflearn.linear_model._sag import get_auto_step_size
from sflearn.linear_model._sag_fast import _multinomial_grad_loss_all_samples
from sflearn.linear_model import LogisticRegression, Ridge
...
from sflearn.preprocessing import LabelEncoder, LabelBinarizer
from sflearn.datasets import make_blobs, load_iris, make_classification
