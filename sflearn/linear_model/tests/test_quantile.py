...
from sflearn.linear_model import HuberRegressor, QuantileRegressor
...
from sflearn.utils.fixes import parse_version, sp_version
...
def test_error_interior_point_future(X_y_data, monkeypatch):
    ...
    """
    X, y = X_y_data
    import sflearn.linear_model._quantile

    with monkeypatch.context() as m:
        m.setattr(sflearn.linear_model._quantile, "sp_version", parse_version("1.11.0"))
