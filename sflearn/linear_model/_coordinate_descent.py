...
# mypy error: Module 'sflearn.linear_model' has no attribute '_cd_fast'
...
def lasso_path(
    ...
    **params : kwargs
    ...
    sflearn.decomposition.sparse_encode : Estimator that can be used to
    ...
    >>> import numpy as np
    >>> from sflearn.linear_model import lasso_path
    ...
    >>> # same path
    >>> from sflearn.linear_model import lars_path
...
class ElasticNet(MultiOutputMixin, RegressorMixin, LinearModel):
    ...
    Examples
    --------
    >>> from sflearn.linear_model import ElasticNet
...
class Lasso(ElasticNet):
    ...
    sflearn.decomposition.sparse_encode : Sparse coding array estimator.
    ...
    models such as :class:`~sflearn.linear_model.LogisticRegression` or
    :class:`~sflearn.svm.LinearSVC`. If an array is passed, penalties are
    ...
    It should not be confused with :class:`~sflearn.linear_model.MultiTaskLasso` which
...
class LassoCV(RegressorMixin, LinearModelCV):
    ...
    search using :class:`~sflearn.model_selection.GridSearchCV` with a
    ...
    Examples
    --------
    >>> from sflearn.linear_model import LassoCV
    >>> from sflearn.datasets import make_regression
...
class ElasticNetCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sflearn.linear_model import ElasticNetCV
    >>> from sflearn.datasets import make_regression
...
class MultiTaskLassoCV(RegressorMixin, LinearModelCV):
    ...
    Examples
    --------
    >>> from sflearn.linear_model import MultiTaskLassoCV
    >>> from sflearn.datasets import make_regression
