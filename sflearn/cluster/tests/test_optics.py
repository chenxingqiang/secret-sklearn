...
from sflearn.cluster import OPTICS
from sflearn.cluster._optics import _extend_region, _extract_xi_labels
...
def test_compare_to_ELKI():
    ...
    # Does NOT work with metric='euclidean', because sflearn euclidean has
