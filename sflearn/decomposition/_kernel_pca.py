...
class KernelPCA(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def inverse_transform(self, X):
        ...
        .. note:
            :meth:`~sflearn.decomposition.fit` internally uses a centered
        ...
        .. note::
            ...
            :class:`~sflearn.decomposition.PCA` instead. Unlike
            :class:`~sflearn.decomposition.PCA`,
            :class:`~sflearn.decomposition.KernelPCA`'s ``inverse_transform``
