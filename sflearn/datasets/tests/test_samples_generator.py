...
from sflearn.datasets import make_friedman3
...
from sflearn.datasets import make_swiss_roll
from sflearn.datasets import make_s_curve
from sflearn.datasets import make_biclusters
