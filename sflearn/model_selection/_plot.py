...
class LearningCurveDisplay:
    ...
    :meth:`~sflearn.model_selection.LearningCurveDisplay.from_estimator` to
    create a :class:`~sflearn.model_selection.LearningCurveDisplay` instance.
    ...
    See Also
    --------
    sflearn.model_selection.learning_curve : Compute the learning curve.

    Examples
    --------
    >>> import matplotlib.pyplot as plt
    >>> from sflearn.datasets import load_iris
    >>> from sflearn.model_selection import LearningCurveDisplay, learning_curve
    ...
    def plot(
        ...
        *,
        ...
        negate_score : bool, default=False
            ...
            :func:`~sflearn.model_selection.learning_curve`. This is
        ...
        Returns
        -------
        display : :class:`~sflearn.model_selection.LearningCurveDisplay`
    ...
    def from_estimator(
        ...
        *,
        ...
        cv : int, cross-validation generator or an iterable, default=None
            ...
            :class:`~sflearn.model_selection.StratifiedKFold` is used. In all
            other cases, :class:`~sflearn.model_selectionKFold` is used. These
