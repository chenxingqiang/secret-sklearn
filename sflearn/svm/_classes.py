...
class LinearSVC(LinearClassifierMixin, SparseCoefMixin, BaseEstimator):
    ...
    SVC : Implementation of Support Vector Machine classifier using libsvm:
        ...
        :class:`~sflearn.multiclass.OneVsRestClassifier` wrapper.

        Finally SVC can fit dense data without memory copy if the input
        is C-contiguous. Sparse data will still incur memory copy though.

    sflearn.linear_model.SGDClassifier : SGDClassifier can optimize the same
...
class LinearSVR(RegressorMixin, LinearModel):
    ...
    sflearn.linear_model.SGDRegressor : SGDRegressor can optimize the same cost
...
class SVC(BaseSVC):
    ...
    consider using :class:`~sflearn.svm.LinearSVC` or
    :class:`~sflearn.linear_model.SGDClassifier` instead, possibly after a
    :class:`~sflearn.kernel_approximation.Nystroem` transformer or
...
class SVR(RegressorMixin, BaseLibSVM):
    ...
    datasets consider using :class:`~sflearn.svm.LinearSVR` or
    :class:`~sflearn.linear_model.SGDRegressor` instead, possibly after a
    :class:`~sflearn.kernel_approximation.Nystroem` transformer or
    other :ref:`kernel_approximation`.
...
class OneClassSVM(OutlierMixin, BaseLibSVM):
    ...
    See Also
    --------
    sflearn.linear_model.SGDOneClassSVM : Solves linear One-Class SVM using
        Stochastic Gradient Descent.
    sflearn.neighbors.LocalOutlierFactor : Unsupervised Outlier Detection using
        Local Outlier Factor (LOF).
    sflearn.ensemble.IsolationForest : Isolation Forest Algorithm.
