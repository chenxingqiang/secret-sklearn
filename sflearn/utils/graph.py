...
def single_source_shortest_path_length(graph, source, *, cutoff=None):
    ...
    Examples
    --------
    >>> from sflearn.utils.graph import single_source_shortest_path_length
    >>> import numpy as np
...
def _fix_connected_components(
    ...
    **kwargs,
    ...
    metric : str
        Metric used in `sflearn.metrics.pairwise.pairwise_distances`.

    kwargs : kwargs
        Keyword arguments passed to
        `sflearn.metrics.pairwise.pairwise_distances`.
