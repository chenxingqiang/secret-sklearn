...
class NeighborhoodComponentsAnalysis(
    ...
    init : {'auto', 'pca', 'lda', 'identity', 'random'} or ndarray of shape \
        ...
        - `'pca'`
            ...
            (See :class:`~sflearn.decomposition.PCA`)
        ...
        - `'lda'`
            ...
            :class:`~sflearn.discriminant_analysis.LinearDiscriminantAnalysis`)
    ...
    See Also
    --------
    sflearn.discriminant_analysis.LinearDiscriminantAnalysis : Linear
        Discriminant Analysis.
    sflearn.decomposition.PCA : Principal component analysis (PCA).
