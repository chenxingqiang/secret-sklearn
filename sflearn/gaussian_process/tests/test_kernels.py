...
from sflearn.gaussian_process.kernels import _approx_fprime
...
def test_kernel_clone(kernel):
    # Test that sflearn's clone works correctly on kernels.
    kernel_cloned = clone(kernel)

    # XXX: Should this be fixed?
    # This differs from the sflearn's estimators equality check.
