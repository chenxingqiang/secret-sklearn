...
class Hyperparameter(
    ...
    Examples
    --------
    >>> from sflearn.gaussian_process.kernels import ConstantKernel
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import Hyperparameter
...
class CompoundKernel(Kernel):
    ...
    Examples
    --------
    >>> from sflearn.gaussian_process.kernels import WhiteKernel
    >>> from sflearn.gaussian_process.kernels import RBF
    >>> from sflearn.gaussian_process.kernels import CompoundKernel
...
class Sum(KernelOperator):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import RBF, Sum, ConstantKernel
...
class Product(KernelOperator):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import (RBF, Product,
    ...            ConstantKernel)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class Exponentiation(Kernel):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import (RationalQuadratic,
    ...            Exponentiation)
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import RBF, ConstantKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
    >>> kernel = RBF() + ConstantKernel(constant_value=2)
    >>> gpr = GaussianProcessRegressor(kernel=kernel, alpha=5,
    ...         random_state=0).fit(X, y)
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import DotProduct, WhiteKernel
    >>> X, y = make_friedman2(n_samples=500, noise=0, random_state=0)
...
class Matern(RBF):
    ...
    >>> from sflearn.datasets import load_iris
    >>> from sflearn.gaussian_process import GaussianProcessClassifier
    >>> from sflearn.gaussian_process.kernels import Matern
    >>> X, y = load_iris(return_X_y=True)
...
class ExpSineSquared(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    >>> from sflearn.datasets import make_friedman2
    >>> from sflearn.gaussian_process import GaussianProcessRegressor
    >>> from sflearn.gaussian_process.kernels import ExpSineSquared
    >>> X, y = make_friedman2(n_samples=50, noise=0, random_state=0)
...
class PairwiseKernel(Kernel):
    """Wrapper for kernels in sflearn.metrics.pairwise.

    A thin wrapper around the functionality of the kernels in
    sflearn.metrics.pairwise.
    ...
    >>> from sflearn.datasets import load_iris
    >>> from sflearn.gaussian_process import GaussianProcessClassifier
    >>> from sflearn.gaussian_process.kernels import PairwiseKernel
    >>> X, y = load_iris(return_X_y=True)
