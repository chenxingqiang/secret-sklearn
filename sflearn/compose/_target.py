...
class TransformedTargetRegressor(RegressorMixin, BaseEstimator):
    ...
    such as the :class:`~sflearn.preprocessing.QuantileTransformer` or as a
    ...
    regressor : object, default=None
        ...
        :class:`~sflearn.base.RegressorMixin`. This regressor will
        automatically be cloned each time prior to fitting. If `regressor is
        None`, :class:`~sflearn.linear_model.LinearRegression` is created and used.

    transformer : object, default=None
        Estimator object such as derived from
        :class:`~sflearn.base.TransformerMixin`. Cannot be set at the same time
    ...
    See Also
    --------
    sflearn.preprocessing.FunctionTransformer : Construct a transformer from an
        arbitrary callable.
