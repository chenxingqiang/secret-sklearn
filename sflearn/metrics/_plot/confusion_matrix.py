...
class ConfusionMatrixDisplay:
    ...
    :func:`~sflearn.metrics.ConfusionMatrixDisplay.from_estimator` or
    :func:`~sflearn.metrics.ConfusionMatrixDisplay.from_predictions` to
    ...
    >>> from sflearn.metrics import confusion_matrix, ConfusionMatrixDisplay
    ...
    def plot(
        ...
        *,
        ...
        Returns
        -------
        display : :class:`~sflearn.metrics.ConfusionMatrixDisplay`
            Returns a :class:`~sflearn.metrics.ConfusionMatrixDisplay` instance
