...
.. glossary::
    ...
    backwards compatibility
        ...
        Serialization
            ...
            subsequent version.  (For estimators in the sflearn package, we
    ...
    categorical feature
        ...
        :class:`~sflearn.preprocessing.OrdinalEncoder` helps encoding
        string-valued categorical features as ordinal integers, and
        :class:`~sflearn.preprocessing.OneHotEncoder` can be used to
    ...
    cloned
        ...
        :term:`attributes`, using :func:`~sflearn.base.clone`.
    ...
    common tests
        ...
        implementation in ``sflearn/utils/estimator_checks.py``.
    ...
    examples
        ...
        * as doctests in their docstrings (i.e. within the ``sflearn/`` library
          code itself).
...
.. glossary::
    ...
    ``random_state``
        ...
        other function like :func:`~sflearn.cluster.k_means`). `random_state`'s
        value may be:
