...
- The ``labels`` parameter to :func:`sflearn.metrics.f1_score`,
  :func:`sflearn.metrics.fbeta_score`,
  :func:`sflearn.metrics.recall_score` and
  :func:`sflearn.metrics.precision_score` has been extended.
...
- Provide an option for sparse output from
  :func:`sflearn.metrics.pairwise.cosine_similarity`. By
