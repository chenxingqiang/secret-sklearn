...
.. topic:: Data transformation with held out data
    ...
    A :class:`Pipeline <sflearn.pipeline.Pipeline>` makes it easier to compose
...
:class:`KFold`.
  ...
  >>> from sflearn.model_selection import StratifiedKFold, KFold
  >>> import numpy as np
...
:func:`~sflearn.model_selection.permutation_test_score` offers another way
...
:func:`~sflearn.model_selection.permutation_test_score` generates a null
...
samples.
:func:`~sflearn.model_selection.permutation_test_score` provides information
...
Finally, :func:`~sflearn.model_selection.permutation_test_score` is computed
