...
The :mod:`sflearn.metrics.pairwise` submodule implements utilities to evaluate
...
.. currentmodule:: sflearn.metrics.pairwise
...
(Note that the tf-idf functionality in ``sflearn.feature_extraction.text``
...
:class:`~sflearn.svm.SVC` with ``kernel="precomputed"``::

    >>> from sflearn.svm import SVC
    >>> from sflearn.metrics.pairwise import chi2_kernel
    >>> X = [[0, 1], [1, 0], [.2, .8], [.7, .3]]
    >>> y = [0, 1, 0, 1]
