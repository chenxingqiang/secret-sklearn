...
.. note::
  ...
  via the :class:`~sflearn.calibration.CalibratedClassifierCV` (see
  ...
  :class:`~sflearn.calibration.CalibratedClassifierCV`.
...
=====================
  ...
  * **Avoiding data copy**: For :class:`SVC`, :class:`SVR`, :class:`NuSVC` and
    ...
    <sflearn.linear_model.LogisticRegression>`) any input passed as a numpy
    ...
    <sflearn.linear_model.SGDClassifier>` class instead.  The objective
  ...
  * Support Vector Machine algorithms are not scale invariant, so **it
    ...
    easily by using a :class:`~sflearn.pipeline.Pipeline`::
...
is advised to use :class:`~sflearn.model_selection.GridSearchCV` with
...
.. note::
    ...
    estimator used is :class:`~sflearn.linear_model.Ridge` regression,
