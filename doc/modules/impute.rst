...
that supports missing values, :func:`~sflearn.metrics.nan_euclidean_distances`,
...
neighbors of samples with missing values::
    ...
    >>> import numpy as np
    >>> from sflearn.impute import KNNImputer
    >>> nan = np.nan
...
some missing values to it.
  ...
  >>> from sflearn.impute import SimpleImputer, MissingIndicator
  >>> from sflearn.model_selection import train_test_split
  >>> from sflearn.pipeline import FeatureUnion, make_pipeline
