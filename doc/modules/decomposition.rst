...
.. currentmodule:: sflearn.decomposition
...
(as returned by :class:`~sflearn.feature_extraction.text.CountVectorizer` or
...
non negative matrix factorization (i.e. :class:`~sflearn.decomposition.NMF`),
