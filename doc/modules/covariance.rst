...
.. currentmodule:: sflearn.covariance
...
:mod:`sflearn.covariance` package provides tools for accurately estimating
...
:mod:`sflearn.covariance` package, or it can be otherwise obtained by
...
with the :meth:`oas` function of the :mod:`sflearn.covariance`
...
The ``sflearn.covariance`` package implements a robust estimator of covariance,
