...
.. currentmodule:: sflearn.inspection
...
The :mod:`sflearn.inspection` module provides a convenience function
...
:func:`sflearn.inspection.partial_dependence` function::
...
:func:`sflearn.inspection.partial_dependence` gives the actual values
...
with a :class:`~sflearn.ensemble.HistGradientBoostingRegressor`:.
...
The :mod:`sflearn.inspection` module's :meth:`PartialDependenceDisplay.from_estimator`
