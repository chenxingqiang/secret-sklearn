...
.. prompt:: bash $
  ...
  pytest -v sflearn/linear_model/tests/test_logistic.py::test_sparsify
...
.. prompt:: bash $
  ...
  pytest sflearn/tests/test_common.py -v -k LogisticRegression
...
Issue: Software versions
    ::
        ...
        ```py
        import sflearn; sflearn.show_versions()
        ```
        Thanks.
