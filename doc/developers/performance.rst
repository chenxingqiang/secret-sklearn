...
dataset and as in the :ref:`sphx_glr_auto_examples_classification_plot_digits_classification.py` example::
  ...
  In [1]: from sflearn.decomposition import NMF

  In [2]: from sflearn.datasets import load_digits
...
Now restart IPython and let us use this new toy::
  ...
  In [1]: from sflearn.datasets import load_digits

  In [2]: from sflearn.decomposition import NMF
    ... : from sflearn.decomposition._nmf import _nls_subproblem
  ...
  File: sflearn/decomposition/nmf.py
...
`sflearn/utils/_openmp_helpers.pyx <https://github.com/scikit-learn/scikit-learn/blob/main/sflearn/utils/_openmp_helpers.pyx>`_
