...
:func:`~sflearn.inspection.PartialDependenceDisplay.from_estimator` and
:class:`~sflearn.inspection.PartialDependenceDisplay` support plotting on
...
See for example, :func:`~sflearn.inspection.PartialDependenceDisplay.from_estimator
