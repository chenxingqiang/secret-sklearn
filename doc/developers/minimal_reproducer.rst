...
:mod:`sflearn.datasets` module. Most of the times the bug is not related to a
...
as :class:`sflearn.preprocessing.StandardScaler`.
...
As hinted by the name, :class:`sflearn.datasets.make_regression` produces
...
:class:`sflearn.datasets.make_classification` creates multiclass datasets with multiple Gaussian
...
Similarly to `make_classification`, :class:`sflearn.datasets.make_blobs` creates
