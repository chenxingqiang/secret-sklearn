...
The ``sflearn.datasets`` package embeds some small toy datasets
...
Both loaders and fetchers functions return a :class:`~sflearn.utils.Bunch`
...
For more information about Bunch object, see :class:`~sflearn.utils.Bunch`.
